...
async def init_library():
    ...
    # white_channel = client.get_channel(751864967442989089)
    # black_channel = client.get_channel(751864988544663615)
    # black_channel = client.get_channel(752122667758387220)
...
async def create_card_channels():
    ...
    for member in server.members:
        if not get_viewable_channel(member):
            ...
            await client.get_channel(751870433988706436).send("Created a card channel for " + member.display_name)
...
async def on_ready():
    print("ready!")
    # await init_game(client.get_channel(751864765080403969), client.get_channel(751864765080403970))
